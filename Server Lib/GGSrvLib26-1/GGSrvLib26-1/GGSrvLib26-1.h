...
GGAUTHS_API void __CDECL NpLog(int mode, char* msg);
...
GGAUTHS_API void __CDECL GGAuthUpdateCallback(PGG_UPREPORT report);
...
GGAUTHS_API UINT32   __CDECL GGAuthDeleteUser(LPGGAUTH pGGAuth);
GGAUTHS_API UINT32	__CDECL GGAuthInitUser(LPGGAUTH pGGAuth);
GGAUTHS_API UINT32   __CDECL GGAuthCloseUser(LPGGAUTH pGGAuth);
GGAUTHS_API UINT32   __CDECL GGAuthGetQuery(LPGGAUTH pGGAuth, PGG_AUTH_DATA pAuthData);
GGAUTHS_API UINT32   __CDECL GGAuthCheckAnswer(LPGGAUTH pGGAuth, PGG_AUTH_DATA pAuthData);
...
GGAUTHS_API UINT32	__CDECL GGAuthGetState(LPGGAUTH pGGAuth, PGG_CSAUTH_STATE pAuthState);
GGAUTHS_API UINT32	__CDECL	GGAuthSetState(LPGGAUTH pGGAuth, PGG_CSAUTH_STATE pAuthState);
GGAUTHS_API UINT32	__CDECL	GGAuthSetSecureOrder(LPGGAUTH pGGAuth);
GGAUTHS_API UINT32   __CDECL GGAuthCheckUserCSAuth(LPGGAUTH pGGAuth, bool bCheck);
