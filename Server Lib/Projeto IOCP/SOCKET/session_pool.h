...
namespace stdA {
    ...
    class session_pool {
        public:
			session_pool(size_t _TTL = 10000 );
            session_pool(threadpool* _threadpool, size_t _max_session, size_t _TTL = 10000 );
            ~session_pool();

			void init(threadpool* _threadpool, size_t _max_session, size_t _TTL = 10000 );
