...
void CmdAddWarehouseItem::lineResult(result_set::ctx_res* _result, uint32_t _index_result) {
	...
	if ((m_flag_iff == IFF::Part::UCC_BLANK || m_flag_iff == IFF::Part::UCC_COPY) && _result->cols == 3) {
	...
	}else if (!(m_flag_iff == IFF::Part::UCC_BLANK || m_flag_iff == IFF::Part::UCC_COPY) && (_index_result == 1 || _index_result == 0)) {
