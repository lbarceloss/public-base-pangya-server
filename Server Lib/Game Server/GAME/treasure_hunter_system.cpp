...
#define TREASURE_HUNTER_TIME_UPDATE (30 * 60)
#define TREASURE_HUNTER_LIMIT_POINT_COURSE 1000
#define TREASURE_HUNTER_INCREASE_POINT	50
#define TREASURE_HUNTER_BOX_PER_POINT	100
...
void TreasureHunterSystem::initialize() {
	...
	CmdTreasureHunterInfo cmd_thi(true);
	...
	CmdTreasureHunterItem cmd_thItem(true);
...
float TreasureHunterSystem::getCourseRate(unsigned char _course) {
	...
	if (point > 0)
		rate_course = (float)point / TREASURE_HUNTER_LIMIT_POINT_COURSE;
