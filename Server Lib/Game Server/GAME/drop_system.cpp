...
#define ART_WICKED_BROOMSTICK		0x1A0001B4u
#define ART_TEORITE_ORE				0x1A0001B6u
#define ART_REDNOSE_WIZBERRY		0x1A0001B8u
#define ART_MAGANI_FLOWER			0x1A0001BAu
...
void DropSystem::initialize() {
	...
	CmdDropCourseConfig cmd_dcc(true);
	...
	CmdDropCourseInfo cmd_dci(true);
